...
namespace jg739415MIS4200.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "vehicleID,datePurchased,ownerId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "vehicleID,datePurchased,ownerId")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
